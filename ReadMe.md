...
Detector + Tracker (classical hybrid)-
...
4. KPIs and Runtime / Jetson Feasibility Estimate
...
5. Key Trade-offs and What I’d Do With More Time
Hardware limitations & workflow efficiency:
...
Improving the detector for reliable re-detection:
...
Project-level open questions requiring clarification:
